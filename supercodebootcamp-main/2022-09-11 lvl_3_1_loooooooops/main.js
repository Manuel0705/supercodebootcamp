...
// Welche string methoden zerschneiden den string ?
...
//     // }
//     let i = 1
//     for (; i <= Math.ceil(text.length / 100);) {
//         // console.log(i);
//         textArr.push(text.slice(startPosition, endPosition));
//         startPosition += 100;
//         endPosition += 100;
//         i++
//     }
...
//  Möglichkeit 2 ohne Math.ceil();
const cutText = () => {
    // for(start; condition; steps){
    // 
    // }

    for (let i = 1; i < text.length; i += 100) {
        // console.log(i);
        textArr.push(text.slice(startPosition, endPosition));
        startPosition += 100;
        endPosition += 100;
